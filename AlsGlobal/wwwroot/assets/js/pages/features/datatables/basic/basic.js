...
var KTDatatablesBasicBasic = function() {
	...
	var initTable1 = function() {
		...
		var filter = new FilterDataTable(datatable);
		console.log(filter);
		// implementarFiltros($('#kt_datatable'));
	};
