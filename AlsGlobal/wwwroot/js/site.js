...
var removerBotonAllSelect = function () {
    $(".actions-btn.bs-select-all.btn.btn-light").css("display", "none");

        // $(".actions-btn.bs-select-all.btn.btn-light").remove();
}
var mostrarSelectAll = function () {
    var div = $("select[data-show-selectAll=true]").closest("div");
    $(div).find(".actions-btn.bs-select-all.btn.btn-light").css("display", "block");
}
var cambiarIdiomaSelect = function () {
    $(".actions-btn.bs-select-all.btn.btn-light").html(select_SeleccionarTodo);
